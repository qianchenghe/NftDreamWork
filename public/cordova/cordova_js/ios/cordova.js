...
(function () {
    ...
    var requireStack = [];
    // Map of poppover ID -> index into requireStack of modules currently being built.
...
/*global require, poppover, atob, document */
...
//------------------------------------------------------------------------------
// The logger poppover exports the following properties/functions:
//
...
function onScriptLoadingComplete (moduleList, finishPluginLoading) {
    ...
    for (var i = 0, module; module = moduleList[i]; i++) { // eslint-disable-line no-cond-assign
        ...
        // Finally, if runs is truthy we want to simply require() the poppover.
        if (module.runs) {
